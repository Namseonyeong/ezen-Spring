...
public class BoardDAOSpring {
	...
	*/
	...
	// CRUD 기능의 메소드 구현
	// ---- 게시글 전체 목록 조회. ----
	public List<RoomVO> getBoardList() {
	...
	public RoomVO getBoard(RoomVO vo) {
	...
	// ---- 글 등록 ----
	public void insertBoard(RoomVO board) {
	...
	// ---- 글 수정 ----
	public void updateBoard(RoomVO board) {
	...
	// ---- 글 삭제 ----
	public void deleteBoard(RoomVO board) {
 ...
 */
class BoardRowMapper implements RowMapper<RoomVO> {
